...
import '../pages_css/LecturesReviewUpdate.css';
        ...
        <div style={{ width: '60%', height: '410px', textAlign: 'center', display: 'inline-block', borderRadius: '10px', backgroundColor: 'white', }}>
          ...
          <form class="mb-3" name="myform" id="myformA" method="post">
            <fieldset style={{ }}>
              ...
              <input type="radio" name="reviewStar" value="5" id="rate1" /><label id='star5' class='reviewStarA' for="rate1" onClick={() => {$('#lecturesAdd_startNum').val('5')}}>⭐</label>
              <input type="radio" name="reviewStar" value="4" id="rate2" /><label id='star4' class='reviewStarA' for="rate2" onClick={() => {$('#lecturesAdd_startNum').val('4')}}>⭐</label>
              <input type="radio" name="reviewStar" value="3" id="rate3" /><label id='star3' class='reviewStarA' for="rate3" onClick={() => {$('#lecturesAdd_startNum').val('3')}}>⭐</label>
              <input type="radio" name="reviewStar" value="2" id="rate4" /><label id='star2' class='reviewStarA' for="rate4" onClick={() => {$('#lecturesAdd_startNum').val('2')}}>⭐</label>
              <input type="radio" name="reviewStar" value="1" id="rate5" /><label id='star1' class='reviewStarA' for="rate5" onClick={() => {$('#lecturesAdd_startNum').val('1')}}>⭐</label>
