...
import mainPic from '../../assets/mainCoding.png';
import subPic1 from '../../assets/subCoding1.png';
import subPic2 from '../../assets/subCoding2.png';
import subPic3 from '../../assets/subCoding3.png';
...
const MainCard = () => {
  return (
    <div className="main_card">
      <div>
        <img src={mainPic} className="main_picture"/>
      </div>
      <div className="main_text_box">
        <h2>코딩 강의, 어떻게 골라야할지 막막하셨나요?</h2>
        <p>강의 후기, 코딩 스터디, 로드맵 추천까지</p>
        <Link to="/lectures" id="linkBox">
          <p id="linkButton">추천 강의 보러가기</p>
        </Link>
      </div>
