...
import '../../styles/studies/StudiesAdd.css';
  ...
  return (
    <div id='body_main' style={{ background:'rgb(240, 240, 240)', }}>
      ...
      <div style={{ width: '60%', height: '850px', display: 'inline-block', borderRadius: '10px', background: 'white', }}>
        ...
        <div id ='studiesAdd_peeple'>모집인원수&nbsp;&nbsp;
          <input id='studiesAdd_max' type='number' min='2'/>
          &nbsp;&nbsp;/&nbsp;&nbsp;
        ...
        <div style={{ width: '98%', margin: '10px 15px', textAlign: 'center', }}>
          <button style={{ margin: '10px 0px', color: 'white', borderRadius: '5px', backgroundColor: '#17173D', }} onClick={() => {
            ...
            axios({
              ...
              method: 'POST',
              data: {
                s_location: $('#studiesAdd_locationInput').val(),
                s_category: $('#studiesAdd_categoryInput').val(),
                studytitle: $('#studiesAdd_titleInput').val(),
                studycontent: $('#studiesAdd_descriptionInput').val(),
                minrequirement: $('#studiesAdd_min').val(),
                maxrequirement: $('#studiesAdd_max').val(),
              },
              headers: {
