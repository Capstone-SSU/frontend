...
import '../../../styles/mypages/my_roadmaps/myLikeRoadmaps.css';
...
const MyLikeRoadmaps = ({ auth }) => {
    var navigate = useNavigate();
    const [data, setData] = useState([]);
    useEffect(() => {
        let isComponentMounted = true
        axios({
            url: '/api/likeroadmaps/'+auth.nickname,
            method: 'POST',
            headers: {
        ...
        <>
            <div id='body_flex' style={{ minWidth: '1176px', background: '#17173D' }}>
                ...
                <div id='myProfile_body'>
                    ...
                    <div id="myLikeRoadmaps_main">
                        <MLRo_Card getData={data} />
                    </div>
                </div>
            </div>
        </>
